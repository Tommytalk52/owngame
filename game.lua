...
-- setup background
	...
	if fatpix then -- do something funky
		...
		it.shader_uniforms.cy0={ 1    , 0.5  , 0    , 1   }
		it.shader_uniforms.cy1={ 1    , 0.5  , 0    , 1   }
		it.shader_uniforms.cy2={ 1    , 0.5  , 0    , 1   }
		it.shader_uniforms.cy3={ 1    , 0.5  , 0    , 1   }
		it.shader_uniforms.cy4={ 1    , 0.5  , 0    , 1   }
